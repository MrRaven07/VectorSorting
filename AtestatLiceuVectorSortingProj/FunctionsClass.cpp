    ...
    while (mwindow.pollEvent(event)) {
        switch (event.type){
            ...
            case sf::Event::MouseWheelScrolled:
                float adjustTime = (1.f / (60.f * 3.f)) * -1 * event.mouseWheelScroll.delta;
                TimePerFrame= sf::seconds(TimePerFrame.asSeconds()+adjustTime);
            break;
...
void game::update(){
        ...
        switch(whichMode){
            ...
            case 1: // menu
                ...
                //std::cerr << PatrateText[PatrateTextState]<< '\n';
